...
img_col[2].markdown("<p style='text-align: left; color: #FF577F;'><b> Like: "+str(one)+"</b></p><p style='text-align: right; color: #3b5999;'><b> Dislike: "+str(ze)+"</b></p>", unsafe_allow_html=True)
