...
img_col[2].markdown("<p style='text-align: justify; color: #FF577F;'><b> Liked: "+one+"</b></p>", unsafe_allow_html=True)
img_col[2].markdown("<p style='text-align: justify; color: #3b5999;'><b> Disliked: "+ze+"</b></p>", unsafe_allow_html=True)
