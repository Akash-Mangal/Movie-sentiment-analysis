...
for i in coment:
    if pred[a]==0:
        a+=1
        img_col[1].markdown("<p style='text-align: justify; color: #3b5999;'><b>"+i+"</b></p>", unsafe_allow_html=True)  
    else:
       a+=1
       img_col[1].markdown("<p style='text-align: justify; color: #FF577F;'><b>"+i+"</b></p>", unsafe_allow_html=True) 
...
img_col[2].markdown("<p style='text-align: justify; color: #FF577F;'><b> Liked: "+str(one)+"</b></p>", unsafe_allow_html=True)
img_col[2].markdown("<p style='text-align: justify; color: #3b5999;'><b> Disliked: "+str(ze)+"</b></p>", unsafe_allow_html=True)
